/*
 * The following three lines configure the module, overriding the default values.
 */
#include <limits.h>
#define MBEDTLS_CTR_DRBG_RESEED_INTERVAL INT_MAX
#define MBEDTLS_CTR_DRBG_ENTROPY_LEN 0
